      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <h2 class="display-4 text-center" style="margin-top: 20px">
            <i class="fa fa-camera" aria-hidden="true" style="color: blue"></i>
            Add New Photo
          </h2>
          <!-- row start -->
          <div class="row">
            <div class="col-md-12">
              <form action="" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <small id="fileHelpId" class="form-text text-muted">Maximum: 80MB</small>
                </div>

                <div class="form-group">
                  <button type="submit" name="submit" class="btn btn-success">Add Photo</button>
