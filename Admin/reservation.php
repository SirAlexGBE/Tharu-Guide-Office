...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3">
          <a href="Add-photo.php" class="btn btn-primary btn-block" style="margin-top: 20px">
          ...
          <a href="reservation.php" class="btn btn-primary btn-block" style="margin-top: 20px">
            <i class="fa fa-book" aria-hidden="true" style="font-size: medium"></i>
            &nbsp; Reservation
          </a>
            ...
            <table class="table table-dark table-hover table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="edit-booking.php?ID=<?php echo $a;?> &name= <?php echo $b;?>&address=<?php echo $c;?> &phone=<?php echo $d;?> &email=<?php echo $e;?> &rooms=<?php echo $f;?>">Edit</a>
                  </td>
